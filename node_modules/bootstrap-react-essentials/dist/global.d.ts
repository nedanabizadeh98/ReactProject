...
declare global {
    ...
    namespace HTTPClient {
        type Config = Pick<AxiosRequestConfig, "baseURL" | "data" | "headers" | "method" | "url"> & Readonly<{
            params?: URLQueryMap;
        }>;
    }
    ...
    namespace Repository {
        ...
        interface URLDataSync {
            get<T>(location: Parameters<typeof getURLComponents>[0], override?: URLDataSync.OverrideConfig): Promise<T>;
            update<T>(location: Parameters<typeof getURLQuery>[0], data: T, override?: URLDataSync.OverrideConfig): Promise<T>;
        }
    }
}
